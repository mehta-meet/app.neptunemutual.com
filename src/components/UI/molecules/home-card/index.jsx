  ...
  return (
    <div
      className={classNames(
        "w-full lg:w-96 py-6 lg:py-0 lg:h-36 bg-white rounded-2xl hover:shadow-homeCard md:rounded-none lg:rounded-2xl border-0.5 md:border-0  lg:border-0.5 border-B0C4DB lg:border-B0C4DB flex justify-center items-center",
        className
      )}
    >
